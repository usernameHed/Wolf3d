...
** Last update Sun Dec 21 09:04:49 2014 ugo belfiore
*/
...
/*
** laby: variable de la création aléatoire du labyrinthe.
*/
...
int	my_putnbr_base_wolf(int nbr, int coef, int poney);
...
/*
** fonction de création du labyrinthe aléatoire.
*/
