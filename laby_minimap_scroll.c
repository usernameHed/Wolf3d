...
** Last update Sun Dec 21 17:33:03 2014 ugo belfiore
*/
...
** (pour l'affichage de la map en grand).
*/
...
/*
** affiche le rectangle à la bonne position.
** (pour l'affichage de la map en petit, seulement 11 carré va être affiché).
*/
...
**	  au bord de la map. (le scrolling s'dapte).
*/
